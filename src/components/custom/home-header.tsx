...
const HomeHeader = () => {
  ...
  return (
    <div className=" flex justify-evenly">
      <header className="fixed md:mt-4 mt-2.5 top-0 w-11/12 bg-secondary-foreground/2 border-2 dark:border-white/20 border-black/20 backdrop-blur-md flex shadow-md rounded-full z-100 m-2">
      <div className="container mx-auto px-4 py-2 flex justify-between items-center">
        ...
        <Button
          variant="outline" size="icon" className="rounded-full dark:border-white/50 border-black/50 md:hidden"
